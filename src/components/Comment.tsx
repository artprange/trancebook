...
export function Comment({ content, onDeleteComment }: CommentProps) {
  ...
  return (
    <div className={styles.comment}>
      <Avatar
        src="https://images.unsplash.com/photo-1536961229726-d383212033cb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=200&q=80"
        alt=""
      />
